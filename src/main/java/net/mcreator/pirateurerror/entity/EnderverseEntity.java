...
import net.mcreator.pirateurerror.item.EssenceItem;
...
public class EnderverseEntity extends PirateurErrorModElements.ModElement {
	...
	@ObjectHolder("pirateur_error:entitybulletenderverse")
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("enderverse").setRegistryName("enderverse");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3407668, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("enderverse_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletenderverse").setRegistryName("entitybulletenderverse"));
	}
	...
	public static class CustomEntity extends CreeperEntity implements IRangedAttackMob {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(EssenceItem.block, (int) (1)));
		}
	...
	private static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(EssenceItem.block, (int) (1));
		}
