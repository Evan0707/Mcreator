...
import net.mcreator.pirateurerror.procedures.MegaCreeperQuandLentiteMeurtProcedure;
import net.mcreator.pirateurerror.procedures.MegaCreeperQuandLentiteEstBlesseeProcedure;
...
public class MegaCreeperEntity extends PirateurErrorModElements.ModElement {
	public static EntityType entity = null;
	public MegaCreeperEntity(PirateurErrorModElements instance) {
		super(instance, 11);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mega_creeper")
						.setRegistryName("mega_creeper");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -26368, -6750208, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("mega_creeper_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelcreeper(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("pirateur_error:textures/creeper.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				MegaCreeperQuandLentiteEstBlesseeProcedure.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MegaCreeperQuandLentiteMeurtProcedure.executeProcedure($_dependencies);
			}
		}
